...
async function main() {
    ...
    // const seed = biformat( crypto.randomBytes( 8 ), 'dec' )
...
/*
    await oracleExample.deploy( { 
        'saveFile': true 
    } )
*/ 

    // await oracleExample.read( { 'method': 'num' } )
    // await oracleExample.callMethod()
    // await oracleExample.waitForChange()
    // OracleExample.loadKeys()
